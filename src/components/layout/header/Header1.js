				...
				<div className="themeflat-container">
					<div className="header-top-inner">
						<div className="address">
							<Link to="/mailto:"><i className="icon-Vector" /></Link>
							<address><i className="icon-Vector-22" />154 Shorting Road | Scarbrough | ON</address>
						</div>
						<div className="social-icon">
							<Link to="https://www.facebook.com/profile.php?id=61580186941669"><i className="icon-facebook" /></Link>
							<Link to="https://www.instagram.com/nccvolley/<"><i className="icon-instagram" /></Link>
